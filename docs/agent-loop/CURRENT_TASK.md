...
- Status: `FOUNDATION_ACCEPTED / 2C_NO_VIABLE_FIXTURE_HUMAN_BLOCKED`.
...
- Required next action: `HUMAN_RESOLVE_2C_FIXTURE_SCOPE_OR_AUTHORIZE_RESCOPE_BEYOND_ONE_CAPABILITY`.
