...
- Limits: `maxSlices=1`, `maxRepairRounds=4`, historical `maxDesignRounds=3`; final repair round `4 / 4`; `scopeMode=LEDGER_ONLY_RESCOPE`.
...
- Authorization gates: `ruleReady=true`, prior Design 3.2 remains immutable history, ledger-only `scopeReviewVerdict=SCOPE_REVIEW_PASS`, `userContinuationAuthorization=USER_AUTHORIZED_2B18A_LEDGER_ONLY_FINAL_REPAIR_ROUND_4`, and `implementationAuthorized=false`; repair round `4 / 4` is exhausted.
...
- The prior ledger-only rescope authorization through repair round `3 / 3` was exhausted. The user then explicitly authorized `USER_AUTHORIZED_2B18A_LEDGER_ONLY_FINAL_REPAIR_ROUND_4` for only the four retained blocker groups. The public true-count resolver, count-result contract, number selection, delivery, private projection, and settlement remain deferred; no repair round 5, premature audit comments, merge, tag, 2B18B, or 2B19 is authorized.
