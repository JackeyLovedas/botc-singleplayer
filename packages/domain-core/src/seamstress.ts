...
export type SeamstressRelevantRoleId = "philosopher" | "seamstress" | "vortox";
...
export const parseRoleTenureId = (value: unknown): ParseRoleTenureIdResult => {
  ...
  const match = /^role-tenure-v1:seat-(0[1-9]|1[0-2]):role-(philosopher|seamstress|vortox):acquired-revision-([1-9][0-9]*)$/.exec(value);
